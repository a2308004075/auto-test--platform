...
-- 初始化用户角色
INSERT INTO user_role (id, role_name, role_code, description, is_active) VALUES
('00000000-0000-0000-0000-000000000020', '管理员', 'ADMIN', '系统管理员，拥有全部权限', TRUE),
('00000000-0000-0000-0000-000000000021', '普通用户', 'USER', '普通用户，仅可查看和执行', TRUE);
