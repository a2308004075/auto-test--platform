...
-- 2. 测试代码库改名【源代码】，与接口文档一并移入【项目资料】目录（权限编码与按钮权限 parent_id 均不变）
UPDATE `sys_menu` SET `name` = '源代码', `parent_id` = 90, `sort_no` = 1, `updated_at` = NOW() WHERE `id` = 82;  -- 测试代码库 -> 源代码
