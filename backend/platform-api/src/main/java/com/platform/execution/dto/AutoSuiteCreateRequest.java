 ...
 */
@Data
public class AutoSuiteCreateRequest implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotBlank(message = "自动化套件名称不能为空")
    @Size(max = 100, message = "自动化套件名称长度不能超过 100")
    private String name;
