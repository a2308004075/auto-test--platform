...
VALUES (88, 78, '缺陷管理', 2, '', '/project/:id/defects', 'defect/DefectList', 'project:defects', 5, 1, NOW(), NOW());

-- 缺陷管理按钮权限菜单
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `menu_type`, `icon`, `route_path`, `component`, `permission_code`, `sort_no`, `is_active`, `created_at`, `updated_at`)
VALUES
(89, 88, '新建缺陷', 3, NULL, NULL, NULL, 'project:defect:add', 0, 1, NOW(), NOW()),
(90, 88, '编辑缺陷', 3, NULL, NULL, NULL, 'project:defect:edit', 0, 1, NOW(), NOW()),
(91, 88, '删除缺陷', 3, NULL, NULL, NULL, 'project:defect:delete', 0, 1, NOW(), NOW()),
(92, 88, '状态流转', 3, NULL, NULL, NULL, 'project:defect:status', 0, 1, NOW(), NOW()),
(93, 88, '分组管理', 3, NULL, NULL, NULL, 'project:defect:group', 0, 1, NOW(), NOW());
...
VALUES
(97, '缺陷管理', 'project:defects', 'MENU', 17, NULL, 12, 1, '缺陷管理页面', 'display', NOW(), NOW()),
(98, '新建缺陷', 'project:defect:add', 'BUTTON', 97, NULL, 1, 1, '新建缺陷按钮', 'display', NOW(), NOW()),
(99, '编辑缺陷', 'project:defect:edit', 'BUTTON', 97, NULL, 2, 1, '编辑缺陷按钮', 'display', NOW(), NOW()),
(100, '删除缺陷', 'project:defect:delete', 'BUTTON', 97, NULL, 3, 1, '删除缺陷按钮', 'display', NOW(), NOW()),
(101, '状态流转', 'project:defect:status', 'BUTTON', 97, NULL, 4, 1, '缺陷状态流转按钮', 'display', NOW(), NOW()),
(102, '分组管理', 'project:defect:group', 'BUTTON', 97, NULL, 5, 1, '缺陷分组管理按钮', 'display', NOW(), NOW());
...
-- ── 11. 调整测试管理子菜单排序 ──
UPDATE `sys_menu` SET `sort_no` = 1, `updated_at` = NOW() WHERE `id` = 82;
